...
- Sample circle (~20 peers): denser PSI-mutual (reciprocal with you) + an open-visibility clique (`they_trust` stand-in) so Ada↔Grace filaments appear — still no inferred bonds from co-membership.
