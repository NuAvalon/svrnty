...
import { buildSignedBytes, SUITE_HYBRID } from '../crypto/sign-envelope-framing';
...
// FIPS pubkey lengths, asU8, normalizeFingerprintHex, and deriveCanonicalFingerprintHex live in the
...
// SIGN_PUB_LEN/ENC_PUB_LEN/KEM_PUB_LEN/SIG_PUB_LEN, normalizeFingerprintHex, and asU8 →
// fingerprint-canonical.ts (imported + re-exported above).
...
// deriveCanonicalFingerprintHex → fingerprint-canonical.ts (imported + re-exported above).
